...
function CategoryCard({ categoryName, categoryIcon }: any) {
  return (
      ...
      >
       ...
       <BiGame size={22}  className="w-8 h-8 mb-2 text-gray-400 group-hover:text-green-500 transition-all duration-300 ease-in-out transform group-hover:scale-110"/>
