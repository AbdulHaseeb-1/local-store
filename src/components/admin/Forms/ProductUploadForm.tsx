...
export default function ProductUploadForm() {
  ...
  useEffect(() => {
    async function getData() {
      const response = await axios.get("/products/product-form-data");
  ...
  async function HandleSubmit(e: any) {
    ...
    try {
      ...
      const response = await axios.post("/products/product-form-data", form);

      if (response.status === 201) {
        setSuccess(true);
        showToast("Product Uploaded Successfully", "success", 5000);
  ...
  function handleRemoveAttribute(name: any): void {
    setAttributes((attributes: any) => {
      return attributes.filter(
        (attribute: any) => attribute.attributeName !== name
      );
    });
  }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-6 lg:gap-6 ">
              <div className="col-span-2 rounded-lg  space-y-2 ">
                  ...
                  <div className="grid grid-cols-2 gap-3 ">
                    ...
                    <div className="flex flex-col space-y-1">
                      <label
                        ...
                        className={clsx("font-medium", {
                          "text-red-400":
                            error && error.path[0] === "selling_rice",
                        })}
                      >
                        Selling Price
                      </label>
                ...
                <div className="flex flex-wrap gap-2 justify-between py-4 items-center">
                  <div>
                    ...
                    <p className="text-xs dark:text-neutral-400 text-neutral-500">
                      Attribute define specification of the product
                    </p>
                  </div>
                  <AddAttributeForm />
                </div>
                ...
                <div className="grid md:grid-cols-2 ">
                  {attributes.map(
                    (attribute: Record<string, string>, index: number) => (
                      <div key={index}>
                        ...
                        <div className="flex items-center pr-4">
                          ...
                          <span
                            onClick={() => {
                              handleRemoveAttribute(attribute.attributeName);
                            }}
              ...
              <div className=" rounded-lg space-y-6 ">
                ...
                <div className=" pt-2 ">
                  ...
                  <p className=" text-xs dark:text-neutral-400 text-neutral-500">
                    Please input atleast one image{" "}
                  </p>
                </div>
