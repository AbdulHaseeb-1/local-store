...
import { TbCategory, TbCategory2, TbLayoutDashboard } from "react-icons/tb";
...
export default function SideBar(props: {
  ...
  return (
    <div className={`h-full overflow-hidden dark:bg-neutral-900 ${props.sidebarOpen ? "w-56" : "hidden md:block md:w-12"} transition-all duration-300 border-r`}>
      ...
      <nav className={`flex flex-col gap-2 mt-6  ${!props.sidebarOpen ? "items-center" : ""} w-full p-2=`}>
        ...
        <SidebarItem open={props.sidebarOpen} title='Products' icon={<BsBoxes size={22} />} href='#' identifier='products'
          subitems={[
            ...
            { title: "Attributes", href: "/control-panel/products/attributes" }
          ]} />
